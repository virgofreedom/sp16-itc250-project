...
?>
<h3 align="center">New Games Categories</h3>
<?php
...
{#records exist - process
	if($myPager->showTotal()==1){$itemz = "catergory";}else{$itemz = "catergories";}  //deal with plural
    echo '<div align="center">We have ' . $myPager->showTotal() . ' ' . $itemz . '!</div>';
	while($row = mysqli_fetch_assoc($result))
	{# process each row
echo '<div align="center">
<a href="' . VIRTUAL_PATH . 'games/game_list.php?id=' . (int)$row['CategoryID'] . '">' . dbOut($row['Category']) . '</a>';
echo '</div>';
	}
