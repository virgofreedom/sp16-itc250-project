...
$server = 'mysql.rattananeak.com'; #CHANGE TO YOUR MYSQL HOST!!
$username='rattana_admin'; #CHANGE TO YOUR MYSQL USERNAME!!
//END CONFIG AREA ----------------------------------------------------------
...
<table border="1" style="border-collapse:collapse" align="center" width="98%" cellpadding="3" cellspacing="3">
	...
	<?php if(session_read('Privilege')=="developer"){ ?>
		<tr>
	...
	if(session_read('Privilege')=="superadmin" || session_read('Privilege')=="developer"){ ?>
		<tr>
